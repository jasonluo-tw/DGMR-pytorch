...
class DGMR_model(pl.LightningModule):
    ...
    def prepare_data(self):
        self.train_radar_set = RadarDataSet(folder='../data/CWB_train/train_data')
        self.valid_radar_set = RadarDataSet(folder='../data/CWB_train/valid_data')

    def setup(self, stage):
        ## Set up train & val dataset
        self.train_set = self.train_radar_set
        self.valid_set = self.valid_radar_set
    ...
    def training_step(self, batch, batch_idx):
        ...
        for _ in range(1):
            ...
            preds = [self.generator(X) for _ in range(1)]
    ...
    def make_visual(self, xx, yy, preds, fig_index=None):
        ...
        name = ['pics_TW_mse/real', 'pics_TW_mse/fake']
