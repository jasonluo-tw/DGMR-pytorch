...
model = DGMR_model(
    train_path = "../../data/training_data/training/sage_train_demo",
    valid_path = "../../data/training_data/training/sage_train_demo",
    pic_path = "./train_log/pics/v14",
    in_channels = 1,
    base_channels = 16,
    down_step = 4,
    #pred_step = 12,
...
trainer.fit(model,
            ckpt_path="model_weight/v14/DGMR-epoch=008-step=36710.ckpt",
            )
